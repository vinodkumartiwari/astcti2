...
**
** Created: Sun Jan 25 23:42:32 2009
...
public:
    ...
    QIcon icon1;
    icon1.addPixmap(QPixmap(QString::fromUtf8(":/res/res/agt_forward.png")), QIcon::Normal, QIcon::Off);
    actionLogin->setIcon(icon1);
    actionPause = new QAction(MainWindowClass);
    actionPause->setObjectName(QString::fromUtf8("actionPause"));
    QIcon icon2;
    icon2.addPixmap(QPixmap(QString::fromUtf8(":/res/res/agt_pause-queue.png")), QIcon::Normal, QIcon::Off);
    actionPause->setIcon(icon2);
    actionConfigure = new QAction(MainWindowClass);
    actionConfigure->setObjectName(QString::fromUtf8("actionConfigure"));
    QIcon icon3;
    icon3.addPixmap(QPixmap(QString::fromUtf8(":/res/res/configure.png")), QIcon::Normal, QIcon::Off);
    actionConfigure->setIcon(icon3);
    actionAbout = new QAction(MainWindowClass);
    actionAbout->setObjectName(QString::fromUtf8("actionAbout"));
    QIcon icon4;
    icon4.addPixmap(QPixmap(QString::fromUtf8(":/res/res/documentinfo.png")), QIcon::Normal, QIcon::Off);
    actionAbout->setIcon(icon4);
    actionExit = new QAction(MainWindowClass);
    actionExit->setObjectName(QString::fromUtf8("actionExit"));
    QIcon icon5;
    icon5.addPixmap(QPixmap(QString::fromUtf8(":/res/res/exit.png")), QIcon::Normal, QIcon::Off);
    ...
    menuBar->setGeometry(QRect(0, 0, 344, 24));
