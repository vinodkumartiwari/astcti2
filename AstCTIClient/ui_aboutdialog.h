...
**
** Created: Sun Jan 25 23:33:45 2009
...
public:
    ...
    QIcon icon;
    icon.addPixmap(QPixmap(QString::fromUtf8(":/res/res/asteriskcti.png")), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon1;
    icon1.addPixmap(QPixmap(QString::fromUtf8(":/res/res/cancel.png")), QIcon::Normal, QIcon::Off);
    ...
    QIcon icon2;
    icon2.addPixmap(QPixmap(QString::fromUtf8(":/res/res/documentinfo.png")), QIcon::Normal, QIcon::Off);
